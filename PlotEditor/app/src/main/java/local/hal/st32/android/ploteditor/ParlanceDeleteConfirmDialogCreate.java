 ...
 * 就職作品
 *
 * 設定・用語の削除確認のダイアログを生成するクラス
 *
 * @author ohs60224
 */
public class ParlanceDeleteConfirmDialogCreate extends DialogFragment {
     ...
     * テーブル
     */
    private final String _table = "parlances";
    /**
     * アクティビティ
     */
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String msg = getString(R.string.dialog_parlance_delete_msg, name);
