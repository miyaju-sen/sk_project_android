...
public class DeleteAccess extends AsyncTask<String, String, String> {
     ...
     * ログに記載するタグ用の文字列
     */
    private static final String DEBUG_TAG = "DeleteAccess";
    /**
     * アクセス先のURL
     */
    private static final String ACCESS_URL = new AccessURL().getDeleteServlet();
    /**
     * サーバ通信が成功したかどうかのフラグ
